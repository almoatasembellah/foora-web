        ...
        <div class="container-fluid p-0">
            <div class="owl-first header-first position-relative">
                <div class="owl-first-item position-relative">
                    <div class="text ms-5 ">
                        <h1><i class='bx bx-football bx-fade-left bx-rotate-90' style='color:#ff9800'></i>Book a sports
                            <span class="f-span">Playgrounds</span> <br> with your friends</h1>
                    ...
                    <div class="container lets-form ms-3 my-2 p-3">
                        <form class="row ms-4">
                            ...
                            <div class="col-lg mb-1 mb-lg-0 my-1">
                                <button type="submit" class="search-button px-0 mx-0"><i
                                        class='bx bx-search-alt ms-auto py-0'></i></button>
                                <button type="submit" class="main-btn rounded-1 mx-1 mb-2" data-bs-toggle="modal"
                                        data-bs-target="#lets"
                                        data-bs-whatever="">Let's Find A Game
                                </button>
                            </div>
                            <div class="modal fade" id="lets" tabindex="-1" aria-labelledby="exampleModalLabel"
                                 aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5 fw-bolder" id="exampleModalLabel">Make A
                                                Game</h1>
                                                ...
                                                <div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
                                                    <div class="tab-pane fade show active" id="account" role="tabpanel"
                                                        ...
                                                        <div class="row justify-content-center">
                                                            <div class="col-md-6">
                                                                <div class="form-group text-center">
                                                                    ...
                                                                    <p class="text-muted">Please fill it by yard
                                                                        Name</p>
                                                        ...
                                                        <div class="row  mb-4">
                                                            <div class="col-md-6">
                                                                <div class="col-md-3-inline">
                                                                    <label class="text fw-bolder h4"
                                                                           style="font-weight: 500;">Select Your
                                                                        City</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <p class="text-muted">Please fill it by your phone
                                                                        Number</p>
                                                                    <label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <p class="text-muted">Please put the playground
                                                                        location</p>
                                                                    <input type="text" class="form-control"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="h4 fw-bolder">Number of
                                                                        players</label>
                                                                    <p class="text-muted">Put the number you need to
                                                                        fill your game</p>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="h4 fw-bolder">Price of the
                                                                        game</label>
                                                                    <p class="text-muted">Please put the fees or the
                                                                        game price</p>
                                                                    <input type="number" class="form-control"
                                                                           placeholder="EGP">
                                                                    @error('price')
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-warning fw-bolder">Request</button>
                                        </div>
                                    ...
                                    <div class="col-sm-3 my-3">
                                        <div class="thumb-wrapper">
                                            ...
                                            <div class="thumb-content">
                                                ...
                                                <h4><i class='bx bxs-user' style='color:#0a1429'></i> <span>2</span>
                                                    <span>/</span> <span>5</span> <span>Players</span></h4>
                                        ...
                                        <div class="col-sm-3 my-3">
                                            <div class="thumb-wrapper">
                                                ...
                                                <div class="thumb-content">
                                                    ...
                                                    <p><i class='bx bxs-dollar-circle' style='color:#32aa37'></i> <span>300</span>
                                                        <span>EGP</span></p>
                            ...
                            <div class="item active">
                                <div class="row">
                                    <div class="col-sm-3 my-3">
                                        <div class="thumb-wrapper">
                                            <div class="img-box">
                                                <img src="{{asset("img/profile-img.jpg")}}" class="rounded-circle"
                                                     alt="">
                                            </div>
                                            <div class="thumb-content">
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeIn">
                        <div class="row g-0 about-bg rounded overflow-hidden">
                            <div class="col text-center">
                                <img class="img-fluid rounded-2" src="{{asset("img/about2.jpg")}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-6 wow fadeIn">
                        ...
                        <p class="mb-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Possimus illum neque
                            incidunt et inventore.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Lorem ipsum dolor sit amet consectetur.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Lorem ipsum dolor sit, amet consectetur
                            adipisicing.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Lorem ipsum dolor sit amet consectetur
                            adipisicing.</p>
